...
class VideoBean {
    ...
    inner class Creator {
        ...
        var avatarimgid: String? = null
        var backgroundimgid: String? = null
    ...
    inner class Data {
        ...
        var resolutions: List<Resolutions>? = null
        ...
        //相关组
        var videogroup: List<Videogroup>? = null
        var previewurl: String? = null
        var previewdurationms = 0
        var hasrelatedgamead = false
        var marktypes: Any? = null

        //相关歌曲
        private var relateSong: List<SongDetailBean.SongsBean>? = null
        var relatedinfo: String? = null
        var videouserliveinfo: String? = null
        var vid: String? = null
        var durationms = 0
        var playtime = 0

        //点赞数量
        private var praisedCount = 0
        var praised = false
        var subscribed = false
        fun getSubscribeCount(): String {
            return subscribeCount.toString()
        }

        fun setSubscribeCount(subscribeCount: Int) {
        ...
        val sharecount: String
            get() = shareCount.toString()
        var relatesong: List<SongDetailBean.SongsBean>?
            get() = relateSong
            set(relatesong) {
                relateSong = relatesong
            }

        fun setPraisedcount(praisedcount: Int) {
            praisedCount = praisedcount
        }

        val praisedcount: String
            get() = praisedCount.toString()
    }

    inner class VideoEntity {
        var type = 0
        var displayed = false
        var alg: String? = null
        var extalg: String? = null
        var data: Data? = null
    }
