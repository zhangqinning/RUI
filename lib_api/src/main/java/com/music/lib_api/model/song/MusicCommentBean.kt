...
class MusicCommentBean {
    ...
    var hotComments: List<CommentsBean>? = null
    var comments: List<CommentsBean>? = null
    fun setIsMusician(isMusician: Boolean) {
        isIsMusician = isMusician
    }
    ...
    class CommentsBean {
        ...
        var beRepliedUser: UserBeanX? = null
        ...
        class UserBeanX {
            ...
            var vipRights: VipRights? = null
            var remarkName: Any? = null
            var vipType = 0
        }

        class VipRights {
            var musicPackage: Any? = null
